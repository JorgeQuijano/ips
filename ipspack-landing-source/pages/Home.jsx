...
export default function Home() {
  return (
    <div className="bg-white min-h-screen">
      ...
      <ScrollReveal><ProductGrid products={PRODUCTS} /></ScrollReveal>
      <ScrollReveal><ServicesSection bgImage={SERVICES_BG} /></ScrollReveal>
      <ScrollReveal><CaseStudies /></ScrollReveal>
      <ScrollReveal><Sustainability /></ScrollReveal>
